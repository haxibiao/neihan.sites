  ...
  <div class="row">
    <div class="container top-part">
      ...
      <div class="download-phone">
        <a href="http://{{ $app }}-1251052432.cosgz.myqcloud.com/{{ $app }}.release.apk"><img src="/images/app/android_app.png" class="download2" alt="download-andorid"></a>
    ...
    <div class="container middle-part">
      <div class="col-sm-12 col-sm-offset-2 text-block">
        ...
        <h6>你是否想查看电竞圈最新娱乐八卦？你是否想了解最深度的游戏内容评测？</br>
          你是否想分享你的游戏故事成为网红大咖？ 燕郊短视频app一网打尽！你想要的我们都有!</h6>
      </div>
