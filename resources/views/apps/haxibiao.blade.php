    ...
    <div class="row">
        <div class="container top-part">
          <div class="top-logo">
            ...
            <div class="info">
              <div class="title">哈希表</div>
              <div class="slogan">随时分享你的互联网经验</div>
            </div>
          </div>
          ...
          <div class="download-phone">
            <a href="{{ env('APK_URL') }}"><img src="/images/app/android_app.png" class="download2" alt="download-andorid"></a>
            <a href="https://itunes.apple.com/cn/app/%E7%82%B9%E5%A2%A8%E9%96%A3/id1434767781?mt=8"><img src="/images/app/ios_app.png" class="download2" alt="download-ios"></a>
      ...
      <div class="row">
          <div class="container middle-part">
            <div class="col-sm-12 col-sm-offset-2 text-block">
              <h3>实时热搜、技术视频、互联网故事、互联网创业</h3>
              <h6>你是否想了解最新的热门搜索内容？你是否想观看最搞笑的段子和视频？</br>
              你是否想分享你的互联网创业成为作者大大？哈希表 app一网打尽！你想要我们都有!</h6>
            </div>          
          </div>
        </div>
        <div class="row">
            <div class="container middle-part">
              <div class="col-sm-3 col-sm-offset-2"><img class="no-border" src="/images/app/{{ $app }}2.png" alt="Misc pic2"></div>
        ...
        <div class="row">
        <div class="container middle-part">
          <div class="col-sm-3 col-sm-offset-2"><img class="no-border" src="/images/app/{{ $app }}4.png" alt="Misc pic4"></div>
          <div class="col-sm-5 col-sm-offset-1 text-block">
            <h3>热门游戏交流社区</h3>
      ...
      <div class="container bottom-part">
        ...
        <div class="bottom-logo">
          ...
          <div class="info">
            <div class="title">哈希表</div>
              <div class="slogan">随时分享你的互联网经历</div>
          </div>
        </div>
      </div>
    </div>
