  ...
  <div class="container-fluid apps">
    <div class="row">
        <div class="container top-part">
          <div class="top-logo">
            <img class="logo" src="/logo/dongmeiwei.com.small.png" alt="app logo">
            <div class="info">
              <div class="title">最暖心的美味社交平台</div>
          ...
          <div class="top-qrcode">
            <img src="/qrcode/dongmeiwei.com.jpg" alt="Download apps page top qrcode">
            <div class="title">扫码下载{{ env('APP_NAME') }}App</div>
            <div class="introduce">随时随地发现和分享内容</div>
          </div>
          <div class="download-phone">
            <a href="http://dongmeiwei-1251052432.file.myqcloud.com/dongmeiwei.apk"><img src="/images/app/android_app.png" class="download2" alt="download-andorid"></a>
            <a href="https://www.pgyer.com/dongmeiwei"><img src="/images/app/ios_app.png" class="download2" alt="download-ios"></a>
      ...
      <div class="container bottom-part">
        <div class="download-web">
          <img class="bottom-qrcode" src="/qrcode/dongmeiwei.com.jpg" alt="Download apps page bottom qrcode">
          <img class="background-img" src="/images/app/appBackground.png" alt="Misc background">
        ...
        <div class="bottom-logo">
          <img src="/logo/dongmeiwei.com.small.png" alt="Misc logo">
          <div class="info">
