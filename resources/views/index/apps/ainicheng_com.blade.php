  ...
  <div class="container-fluid apps">
    <div class="row">
        <div class="container top-part">
          <div class="top-logo">
            <img class="logo" src="/logo/{{ get_domain()}}.small.png" alt="app logo">
            <div class="info">
      ...
      <div class="container bottom-part">
        <img class="bottom-qrcode" src="/qrcode/{{ get_domain() }}.jpg" alt="Download apps page bottom qrcode">
        <img class="background-img" src="/images/appBackground.png" alt="Misc background">
        <div>扫码下载{{ env('APP_NAME') }}App</div>
        <div class="bottom-logo">
          <img src="/logo/{{ get_domain()}}.small.png" alt="Misc logo">
          <div class="info">
            <div class="title">创作你的创作</div>
            <div class="slogan">一个优质创作社区</div>
          </div>
