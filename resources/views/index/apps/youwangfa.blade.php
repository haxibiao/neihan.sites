    ...
    <div class="row">
        <div class="container top-part">
          <div class="top-logo">
            ...
            <div class="info">
              <div class="title">有王法  每天分享一点菜谱和美食</div>
          ...
          <div class="download-phone">
            ...
            <a href="https://itunes.apple.com/cn/app/%E6%87%82%E7%BE%8E%E5%91%B3/id1433177839?mt=8pgyer.com/youwangfa"><img src="/images/app/ios_app.png" class="download2" alt="download-ios"></a>
          ...
          <div class="container middle-part">
            <div class="col-sm-12 col-sm-offset-2 text-block">
              ...
              <h6>一款最新潮的美食软件如果您能拥有，您还会有找不到的菜谱吗?</br>
                ...
                您还会担心有学不会的菜吗? 针对各种人群制作合理饮食，教你 吃出健康。在有王法，带你吃遍天下</h6>
            </div>
          </div>
        </div>
        <div class="row">
      ...
      <div class="container bottom-part">
        ...
        <div class="download-phone">
          <a href="http://{{ $app }}-1251052432.cossh.myqcloud.com/{{ $app }}.apk"><img src="/images/app/android_app.png" class="download2" alt="download-andorid"></a>
          <a href="https://pgyer.com/youwangfa"><img src="/images/app/ios_app.png" class="download2" alt="download-ios"></a>
          <img class="background-img" src="/images/app/appBackground.png" alt="Misc background">
          <h4>点击下载{{ $appname }}App</h4>
        </div>
