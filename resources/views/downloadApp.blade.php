		...
		<div class="row">
		    <div class="container top-part">
		      ...
		      <div class="top-qrcode">
		        <img src="/images/downloadApp.png" alt="Download apps page top qrcode">
		        <div class="title">扫码下载懂美味App</div>
	  	...
	  	<div class="row">
  	      ...
  	      <div class="container middle-part">
  	        <div class="col-sm-5 col-sm-offset-1 text-block">
  	          <h3>百万创作者在懂美味相遇</h3>
  	          <h6>在懂美味，仍有数百万创作者在坚持产出优质创作，有数千万读者在用心交流创作；众多精彩创作，只在懂美味看得到</h6>
  	        </div>
