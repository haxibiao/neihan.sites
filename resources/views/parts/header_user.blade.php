			...
			<div class="navbar-wrp">
				...
				<div class="collapse navbar-collapse navbar-ex1-collapse">
					<ul class="nav navbar-nav">
						<li class="{{ get_active_css('/') }}"><a href="/"><i class="iconfont icon-faxian hidden-xs hidden-md"></i><span class="hidden-sm">发现</span></a></li>
						...
						<li class="{{ get_active_css('follow') }}" class="follow"><a href="/follow"><i class="iconfont icon-huizhang hidden-xs hidden-md"></i><span class="hidden-sm">关注</span></a></li>
						<li class="notification {{ get_active_css('notification') }}" data-hover="dropdown">
					...
					<ul class="nav navbar-nav navbar-right">
						...
						<li class="user" data-hover="dropdown">
							<a href="javascript:;"><img class="avatar" src="{{ Auth::user()->avatar() }}" alt=""><i class="iconfont icon-xiangxiajiantou"></i></a>
						...
						@if(starts_with(request()->path(), 'question'))
							<li class="creation"><a data-target=".modal-ask-question" data-toggle="modal" class="btn-base btn-theme"><span class="iconfont icon-maobi"></span>提问</a></li>
						@else
