			...
			<div class="container">
				...
				<div class="collapse navbar-collapse navbar-ex1-collapse">
					<ul class="nav navbar-nav">
						...
						<li class="tab {{ get_active_css('video_list') }}"><a target="{{ \Agent::isDeskTop()? '_blank':'_self' }}" href="/video_list"><i class="iconfont icon-shipin3 hidden-xs hidden-md"></i><span class="hidden-sm">视频</span></a></li>
