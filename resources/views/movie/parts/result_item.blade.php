<div class="search-result_video">
    <a class="result-thumb lazyload-img" href="/movie/{{ $movie->id }}"   title="{{ $movie->name }}"
        ...
        <div class="infos">
            ...
            <div class="video_info">
                <div class="info_item">
                    ...
                    <span class="content"><a href="javascript:void(0)"  >{{ $movie->producer }}</a></span>
                </div>
                <div class="info_item">
                    <span class="label">主&nbsp;&nbsp;演：</span>
                    <span class="content">
						{{ $movie->actors }}
                        {{-- <a href="javascript:void(0)"  >沈磊</a>
                        <a href="javascript:void(0)"  >程玉珠</a>
                        <a href="javascript:void(0)"  >黄翔宇</a> --}}
                    </span>
                </div>
                <div class="info_item">
                    <span class="label">分&nbsp;&nbsp;类：</span>
                    <span class="content"><a href="javascript:void(0)"  >动漫</a></span>
                </div>
                <div class="info_item info_item_desc">
                    <span class="label">简&nbsp;&nbsp;介：</span>
                    <span class="desc_text">
                        {{ $movie->introduction }}
                        <a class="desc_more" href="/movie/{{ $movie->id }}"  >
