...
<head>
    ...
    <title>{{config('app.name_cn')}}</title>
...
<video id="theVideo" class="video-player"
       src="{{$video->url}}"
       preload="auto" type="video/mp4" width="100%" webkit-playsinline="true" playsinline="true"
       x5-video-player-type="h5" x5-video-player-fullscreen="portraint" onerror="window.VIDEO_FAILED=1"></video>
