...
Vue.component(
	"recommend-authors",
	require("./components/contributeModal/RecommendAuthors.vue")
);
Vue.component(
	"categorys-list",
	require("./components/contributeModal/CategoryList.vue")
);
...
Vue.component(
	"article-tool",
	require("./components/contributeModal/ArticleTool.vue")
);
...
Vue.component(
	"detailmodal-user",
	require("./components/contributeModal/DetailModal_User.vue")
);
Vue.component(
	"detailmodal-home",
	require("./components/contributeModal/DetailModal_Home.vue")
);
//投稿页面模态
Vue.component(
	"modal-contribute",
	require("./components/contributeModal/CategoryModal_User")
);
// 钱包页
Vue.component(
	"recharge-modal",
	require("./components/wallet/RechargeModal.vue")
);
...
Vue.component(
	"withdraw-modal",
	require("./components/wallet/WithdrawModal.vue")
);
Vue.component("support-modal", require("./components/detail/SupportModal.vue"));
// 问答页模态
Vue.component(
	"input-matching",
	require("./components/interlocution/InputMatching.vue")
);
Vue.component(
	"question-modal",
	require("./components/interlocution/QuestionModal.vue")
);
Vue.component(
	"answer-tool",
	require("./components/interlocution/AnswerTool.vue")
);
Vue.component(
	"favorite-question",
	require("./components/interlocution/Favorite.vue")
);
Vue.component(
	"statement-modal",
	require("./components/interlocution/StatementModal.vue")
);
Vue.component(
	"agreement-modal",
	require("./components/interlocution/AgreementModal.vue")
);

// 问题回答页问题的工具
Vue.component(
	"question-tool",
	require("./components/interlocution/QuestionTool.vue")
);
Vue.component(
	"question-list",
	require("./components/interlocution/QuestionList.vue")
);
...
Vue.component(
	"image-select",
	require("./components/contributeModal/ImageSelect.vue")
);
