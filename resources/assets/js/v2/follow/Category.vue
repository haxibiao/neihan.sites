<template>
	...
	<div v-else="category" id="category">
		<div class="main_top">
            <a class="avatar avatar_lg avatar_collection" href="/v2/category/2">
                <img src="/images/category_03.jpg"/>
            </a>
            <a class="btn_base btn_hollow" href="#">
                <span>
                    专题主页
                </span>
            ...
            <a class="btn_base btn_hollow btn_hollow_xs" data-target="#categoryModal_user" data-toggle="modal" href="#">
                <span>
                    投稿
                </span>
            </a>
            <div class="info_meta">
                <a class="headline name_title" href="/v2/category/2">
                    散文
                </a>
                <p class="info_count">
                    <a href="/v1/user" target="_blank">爱你城</a>
                    编 · 收录了140029篇文章 · 1405173人关注
                </p>
            </div>
        </div>
        <div>
            ...
            <div class="tab-content">
                <div class="tab-pane fade in active" id="wenzhang" role="tabpanel">
                    <ul class="article_list">
                        ...
                        <li class="article_item have_img">
                            <a class="wrap_img" href="/v2/detail" target="_blank">
                                <img src="/images/details_02.jpeg"/>
                            </a>
                            <div class="content">
                                <div class="author">
                                    <a class="avatar" href="/v2/user" target="_blank">
                            ...
                            <div class="content">
                                <div class="author">
                                    ...
                                    <div class="info_meta">
                                        ...
                                        <a href="/v2/detail" target="_blank">
                                            <img src="/images/vip2.png" class="badge_icon_xs"/>
                                        </a>
                                        <span class="time">
                                            3周前
                                        </span>
                        ...
                        <li class="article_item have_img">
                            ...
                            <div class="content">
                                ...
                                <a class="headline paper_title" href="/v2/detail" target="_blank">
                                    <span>我们该感谢王者荣耀耗尽了80%的人上升的空间</span>
                                </a>
                                <p class="abstract">
