      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form method="post" action="/question" ref="questionForm">
            ...
            <div class="question-setting">
              <div class="setting-group">
                ...
                <div>
                  <span class="option hot" for="is_pay">
                    <i class="iconfont icon-qianbao"></i>付费咨询
                  </span>
                ...
                <div class="money-amount">
                  <div>
                    ...
                    <a
                      ...
                      v-if="money>balance"
                    >
                      <span class="text-danger">余额不足，去充值</span>
                    </a>
                  </div>
          ...
          <div class="img-selector">
            <div :class="['ask-img-header',top3Imgs.length>0?'bigger':'']">
              添加图片
              <span class="desc">（最多3张）</span>
            </div>
            <div class="img-preview">
              <div class="img-preview-item" v-for="item in top3Imgs">
                <img :src="item.img" alt class="as-height" />
                <div class="img-del" @click="deleteImg(item)">
            ...
            <div class="tab-header">
              <ul>
                <li
                  :class="tabActive=='free'?'tab-header-actived':''"
                  @click="tabSwitch('free')"
                >免费素材库</li>
                <li
                  :class="tabActive=='file'?'tab-header-actived':''"
                  @click="tabSwitch('file')"
                >本地上传</li>
              </ul>
            </div>
            <div class="tab-body">
              <div class="tab-body-item" v-show="tabActive=='free'">
                ...
                <div class="img-container">
                  <div class="img-container-outer">
                    ...
                    <div class="img-list">
                      <div
                        v-for="img in imgItems"
                        :class="['img-item', img.selected ? 'img-item-check':'']"
                        @click="selectImg(img)"
                      >
...
export default {
  ...
  data() {
    return {
      ...
      filesCount: 0,
      top3Imgs: [],
      imgItems: [{ img: "/images/article_01.jpg", title: "", selected: 0 }],
