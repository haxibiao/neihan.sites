<template>
    ...
    <a class="wrap-img" :href="item.actionable.commentable.contentUrl"  >
    ...
    <div class="content">
        <div class="author">
            ...
            <div class="info">
                ...
                <span class="time"> 发表了评论 · {{ item.time }}</span>
            </div>
        </div>
        <div class="comment" ><p v-html="item.actionable.body"></p></div>  
        <blockquote>
            <a class="title"   :href="item.actionable.commentable.contentUrl">
                <span>{{ item.actionable.commentable.title }}</span>
            </a>
            <p class="abstract">
                {{ item.actionable.commentable.description }}
            </p>
            <div class="meta">
                <div class="origin-author">
                    <a   :href="'/user/'+item.user.id">{{ item.user.name }}</a>
                </div>
                <a   :href="'/article/'+item.actionable.commentable.id">
                    <i class="iconfont icon-liulan"></i> {{ item.actionable.commentable.hits }}
                </a>
                <a   :href="'/article/'+item.actionable.commentable.id+'/#comments'">
