...
Route::get('/comment/{id}/{type}/author','Api\CommentController@get_author_comment');
...
Route::middleware('auth:api')->get('/category/commend','Api\CategoryController@commendCategory');
//GET分类下的文章
