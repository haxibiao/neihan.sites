!(function (t) {
    if (((t.__M = t.__M || {}), !t.__M.require)) {
                    ...
                    if (n) {
                        ...
                        'onload' in i
                            ...
                            (i.onreadystatechange = function () {
                                (this.readyState === 'loaded' || this.readyState === 'complete') && a();
                            });
                    }
        ...
        (n = function (t, e) {
            typeof e != 'function' && (e = arguments[2]), (t = t.replace(/\.js$/i, '')), (o[t] = e);
            let n = i[t];
            if (n) {
                for (let r = 0, a = n.length; a > r; r++) {
                    n[r]();
                }
                delete i[t];
            }
        ...
        (e = function (t) {
            ...
            let i = typeof r == 'function' ? r.apply(n, [e, n.exports, n]) : r;
            return (
                i && (n.exports = i),
                n.exports &&
                !n.exports.default &&
            ...
            function a(t) {
                for (var n, r = 0, h = t.length; h > r; r++) {
                    ...
                    p in o ?
                        ...
                        p in s ||
                        ((s[p] = !0), l++, f(p, u, i), (n = c[p] || c[p + '.js']), n && 'deps' in n && a(n.deps));
                }
            }
