...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    init: function init() {
      var m = dy.__M.require("douyin_falcon:node_modules/byted-acrawler/dist/runtime");
    ...
    if (t.__M = t.__M || {}, !t.__M.require) {
        var _e = void 0,
            ...
            if (!(t in u)) {
                ...
                if (n) {
                    var _o = setTimeout(n, _e.timeout);
                    _i.onerror = function () {
                        clearTimeout(_o), n();
                    };
                    var _a = function _a() {
                    ...
                    'onload' in _i ? _i.onload = _a : _i.onreadystatechange = function () {
                        (this.readyState === 'loaded' || this.readyState === 'complete') && _a();
                    };
                }
                return _i.type = 'text/javascript', _i.src = t, r.appendChild(_i), _i;
            }
        },
            f = function f(t, e, n) {
            var r = i[t] || (i[t] = []);
        ...
        n = function n(t, e) {
            ...
            var n = i[t];
            if (n) {
                for (var _r = 0, _a2 = n.length; _a2 > _r; _r++) {
                    n[_r]();
                }
                delete i[t];
            }
            ...
            if (t && t.splice) {
                return _e.async.apply(this, arguments);
            }
            t = _e.alias(t);
            var n = a[t];
            if (n) {
            ...
            var i = typeof r == 'function' ? r.apply(n, [_e, n.exports, n]) : r;
        ...
        }, _e.loadJs = function (t) {
            l(t);
        }, _e.loadCss = function (t) {
            if (t.content) {
                ...
                _n.href = t.url, _n.rel = 'stylesheet', _n.type = 'text/css', r.appendChild(_n);
            }
        }, _e.alias = function (t) {
            return t.replace(/\.js$/i, '');
        }, _e.timeout = 5e3, t.__M.define = n, t.__M.require = _e;
    }
}(this);
...
/* harmony default export */ __webpack_exports__["default"] = (this.__M);
