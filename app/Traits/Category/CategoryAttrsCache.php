...
trait CategoryAttrsCache
{
    public function getNovaLogoCache()
    {
        if ($this->logo) {
    ...
    public function getCanEditCache()
    {
    ...
    public function getFollowedCache()
    {
        return $this->follow_id ? 1 : 0;
    }

    public function getTopAdminsCache()
    {
        return $this->admins()->take(9)->get();
    }

    public function getTopAuthorsCache()
    {
