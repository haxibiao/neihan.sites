...
cd /data/www/neihan.sites/packages/haxibiao/breeze && git config core.filemode false
...
cd /data/www/neihan.sites/packages/haxibiao/dimension && git config core.filemode false
